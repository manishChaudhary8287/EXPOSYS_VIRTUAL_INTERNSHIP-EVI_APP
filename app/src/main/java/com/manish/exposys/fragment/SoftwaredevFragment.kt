...
class SoftwaredevFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_softwaredev, container, false)
        ...
        btnApply=view.findViewById(R.id.btnApplySoftware)
        ...
        btnApply.setOnClickListener {
            ...
            if(checkAllField){
                ...
                val skills="Software Development"
