...
class FullstackFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_fullstack, container, false)
        ...
        btnApply=view.findViewById(R.id.btnApplyFull)
        ...
        btnApply.setOnClickListener {
            ...
            if(checkAllField){
                ...
                val skills="Full Stack Development"
