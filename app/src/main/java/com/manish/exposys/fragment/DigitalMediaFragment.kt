...
class DigitalMediaFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view=inflater.inflate(R.layout.fragment_digital_media, container, false)
        ...
        btnApply=view.findViewById(R.id.btnApplyDigitalMedia)
        ...
        btnApply.setOnClickListener {
            ...
            if(checkAllField){
                ...
                val skills="Digital Media Promoter"
